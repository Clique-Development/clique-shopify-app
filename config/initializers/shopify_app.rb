ShopifyApp.configure do |config|
  ...
  config.old_secret = ""
  config.scope = "read_products,read_orders,read_customers,read_inventory,read_fulfillments,write_products,write_orders,write_inventory, write_publications, read_publications"
